...
namespace MarketProject.Controllers
{
    public class ProduksController : Controller
    {
        ...
        public ProduksController(MarketContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduk,NamaProduk,HargaProduk,JumlahProduk")] Produk produk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduk,NamaProduk,HargaProduk,JumlahProduk")] Produk produk)
        {
