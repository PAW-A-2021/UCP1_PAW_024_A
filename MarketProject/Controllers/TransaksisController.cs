...
namespace MarketProject.Controllers
{
    public class TransaksisController : Controller
    {
        ...
        public TransaksisController(MarketContext context)
        {
            _context = context;
        }
        ...
        {
            var marketContext = _context.Transaksis.Include(t => t.IdAdminNavigation).Include(t => t.IdProdukNavigation).Include(t => t.IdUserNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdTransaksi,IdAdmin,IdUser,IdProduk,TotalTransaksi,TanggalTransaksi")] Transaksi transaksi)
        {
            ...
            ViewData["IdUser"] = new SelectList(_context.Users, "IdUser", "IdUser", transaksi.IdUser);
            return View(transaksi);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTransaksi,IdAdmin,IdUser,IdProduk,TotalTransaksi,TanggalTransaksi")] Transaksi transaksi)
        {
